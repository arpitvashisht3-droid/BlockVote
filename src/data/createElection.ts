...
export const CREATE_ELECTION_CODE = 'BLC-2024-005'
export const CREATE_ELECTION_SLUG = 'blc-2024-005'
...
export const defaultDetails: ElectionDetailsFields = {
  ...
  endTime: '21:00',
  organization: '',
  electionCode: CREATE_ELECTION_CODE,
  slug: CREATE_ELECTION_SLUG,
}

export const defaultCandidates: DraftCandidate[] = [
  {
    id: 'draft-rahul-sharma',
    name: 'Rahul Sharma',
    department: 'Computer Science',
    position: 'President',
    about:
      'A campus leader focused on transparent student government and better academic support.',
  },
  {
    id: 'draft-aman-verma',
    name: 'Aman Verma',
    ...
    position: 'President',
    about:
      'Committed to improved labs, open decision-making, and practical learning opportunities.',
  },
]
