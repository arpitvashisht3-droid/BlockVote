...
import type { RecentVote } from '../../data/dashboard'
    ...
    <section className="card overflow-hidden">
      ...
      {votes.length === 0 ? (
        <div className="border-t border-border px-5 py-10 text-center">
          ...
          <p className="mt-2 text-sm font-medium text-navy">No votes cast yet</p>
          <p className="mt-1 text-xs text-navy-muted">
            When you cast a ballot on the blockchain, your verified vote history will appear here.
          </p>
        </div>
      ) : (
        <>
